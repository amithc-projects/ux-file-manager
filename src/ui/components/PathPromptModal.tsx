      ...
      <div className="relative bg-dark-800 border border-dark-600 shadow-2xl shadow-blue-500/10 rounded-xl w-full max-w-md flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="p-6">
           <label className="block text-sm font-medium text-gray-400 mb-2">
             {t('pathPrompt.labelPrefix')} <span className="text-blue-300 font-mono bg-blue-500/20 px-1 rounded">folder/sub/sub2</span>{t('pathPrompt.labelSuffix')}
           </label>
           <input 
              type="text" 
              autoFocus
              ...
              placeholder={t('pathPrompt.placeholder')}
